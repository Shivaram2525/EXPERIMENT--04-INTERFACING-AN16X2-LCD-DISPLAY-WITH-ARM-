![EX04](https://github.com/user-attachments/assets/bf904a46-356a-4eae-b1e0-4e335f94b263)# EXPERIMENT--04-INTERFACING-AN16X2-LCD-DISPLAY-WITH-ARM AND DISPLAY STRING
...
int main(void)
{
  ...
  Lcd_PortType ports[] = {GPIOA,GPIOA,GPIOA,GPIOA};
    ...
    Lcd_cursor(&lcd, 0,0);
    Lcd_string(&lcd, "Shivaram M.");

    Lcd_cursor(&lcd,1,0);
        Lcd_string(&lcd, "2122223040195");
        HAL_Delay(500);
  while (1)
  {
...
## Output screen shots of proteus  :
 ...
 ![EX04](https://github.com/user-attachments/assets/8fe0f3ed-7ac1-447a-bbd5-83c9daff2a09)
